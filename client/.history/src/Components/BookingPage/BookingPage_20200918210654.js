        ...
        <div className="homePage" style={bookingPageStyle.bookingPageStyle}>
            <div className="homeMainPortion">
                <Row style={{marginRight:"0px"}}>
                    ...
                    <Col sm={12} md={7}>
                    <Form style={bookingPageStyle.myForm}>
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <button type="submit" className="myBtn" style={{width: '100%'}} onClick={onSubmit}>
                            <b> <Link to={goTo} style={{color: 'black'}}>Start Booking</Link></b>
                        </button>
