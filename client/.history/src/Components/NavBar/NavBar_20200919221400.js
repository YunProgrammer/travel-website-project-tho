    ...
    return (
        <div>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                ...
                <FormControl variant="outline-secondary" type="text" placeholder="Search here..." className="mr-sm-2 border rounded-pill mySearchStyle" style={{color: 'white'}} />
                <Button variant="outline-secondary" className="border rounded-pill font-weight-bold">Search</Button>
                </Form>
                <Nav>
                <Nav.Link><Link to="/" className={NavLinksClassVersion}>Home</Link></Nav.Link>
                <Nav.Link><Link to="/booking/0" className={NavLinksClassVersion}>Booking</Link></Nav.Link>
