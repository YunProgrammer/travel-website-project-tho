...
const NavBar = () => {   
    ...
    const classNameDecisionFunction = () =>{
        ...
        return classNameDecision;
    }

    classNameDecision = window.onload = classNameDecisionFunction;

    const NavLinksClassVersion = "ml-sm-2 ml-3 mr-sm-2 mr-3 font-weight-bold navLinks";
    console.log("NabVersion: ", classNameDecision);
    return (
        <div>
