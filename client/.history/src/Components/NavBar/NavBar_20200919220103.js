    ...
    return (
        <div>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                ...
                <FormControl type="text" placeholder="Search here..." className="mr-sm-2 border border-white rounded-pill mySearchStyle"/>
                <Button variant="outline-light" className="border border-white rounded-pill font-weight-bold text-secondary btn-outline-dark">Search</Button>
                </Form>
                <Nav>
