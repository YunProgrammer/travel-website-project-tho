...
// const myKey = "AIzaSyAnRNmsjLqbUwepVXl0Cj4bRldDbZVmkFA";
const SearchPage = () => {
    const center = {
        lat: 23.777176,
        lang: 90.399452,
    ...
    return (
        <div>
            ...
            <script defer
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAnRNmsjLqbUwepVXl0Cj4bRldDbZVmkFA&callback=initMap">
</script>
        </div>
    );
};
